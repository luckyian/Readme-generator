...
var fs = require("fs");
let generateMD = require("./generateMardown.js")
...
function init() {
    ...
    inquirer
        .prompt([
            ...
            data.license.map(userlicense => {
                if (userlicense === "MIT") {
                    userdata.licenseBadge = "https://img.shields.io/badge/License-MIT-yellow.svg";
                }
                else if (license === "GNU GPLv3") {
                    userdata.licenseBadge = "https://img.shields.io/badge/License-GPLv3-blue.svg";
                }
